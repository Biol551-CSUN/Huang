...
### This plot is good because:

- Clear title and axis label to show what the plot is describing

- Separated plots by site, by year with same axis to easily compare between them

- Contrasting color palatte from background, with varying color that won't be conflicting for colorblind

- Density plot for standardized comparison of data